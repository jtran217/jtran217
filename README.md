...
I’m a **fourth-year Computer Science student** with a strong interest in building practical, end-to-end software systems. I enjoy taking ideas from concept to deployment and focusing on tools that solve real, everyday problems.

## 🚀 Current Project

I’m currently working on **PlsFindMeAJob**, a **Dockerized, self-hosted application** designed to:

- Scrape job postings from multiple sources  
- Match roles to user-defined criteria  
- Generate custom, role-specific resumes automatically  

The goal is to give users full control over their data while automating the most time-consuming parts of the job search.
...
- Learning how scalable systems work in real-world settings  
...
I enjoy learning by building, iterating quickly, and improving systems based on real usage and feedback.
